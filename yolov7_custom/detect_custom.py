...
def detect_custom(source, weights='yolov7-e6e.pt', img_size=640, conf_thres=0.25,
...
img_nr = 0
result = detect_custom(f'../images/images/img{img_nr}.jpg')
print(result)